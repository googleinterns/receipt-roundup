...
'                <h4><span class="badge badge-pill badge-secondary">' + categories[0] + '</span></h4>'+
'              </div>'+
'              <div class="col-4 d-flex justify-content-center">'+
'                <h4><span class="badge badge-pill badge-secondary">' + categories[1] + '</span></h4>'+
'              </div>'+
'              <div class="col-4 d-flex justify-content-center">'+
'                <h4><span class="badge badge-pill badge-secondary">' + categories[2] + '</span></h4>'+
'              </div>'+
'            </div>'+
'            <img src=' + receipt.imageURL + ' alt="Receipt image" class="img-fluid receipt-img" />'+
'            <div class="card-body">'+
